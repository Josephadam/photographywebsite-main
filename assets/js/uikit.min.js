...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		...
		? define("uikit", e)
		: ((t = "undefined" != typeof globalThis ? globalThis : t || self).UIkit = e());
})(this, function () {
	"use strict";
				...
				((t = Yt(t)
					.map(function (t, e) {
						var n,
							...
							r = o;
						return (
							"!" === t[0] && ((i = t.substr(1).trim().split(" ")), (r = zt(Et(o), i[0])), (t = i.slice(1).join(" ").trim())),
							"-" === t[0] &&
	...
	function te(t, e, n, i) {
		var r;
		return (
			void 0 === e && (e = !0), void 0 === n && (n = !1), z(t) && ((r = document.createEvent("CustomEvent")).initCustomEvent(t, e, n, i), (t = r)), t
		);
	}
				...
				W(t).map(function (r) {
					return new ce(function (e, n) {
						...
						Zt(
							...
							g(o, Ze) && (a && Ne(r, "uk-transform-origin-" + a), u && Ne(r, Ze + "reverse"));
					});
				})
			)
		);
	...
	function sn(t) {
		for (
			var e = on(t), n = e.top, i = e.left, r = F(t), e = r.ownerDocument, o = e.body, s = e.documentElement, a = r.offsetParent || s;
			a && (a === o || a === s) && "static" === Ve(a, "position");

		)
			a = a.parentNode;
		return (
			_(a) && ((n -= (r = on(a)).top + L(Ve(a, "borderTopWidth"))), (i -= r.left + L(Ve(a, "borderLeftWidth")))),
			{
	...
	function Gn(t) {
		var e = /left|center|right/,
			n = /top|center|bottom/;
		return (
			1 === (t = (t || "").split(" ")).length && (t = e.test(t[0]) ? t.concat("center") : n.test(t[0]) ? ["center"].concat(t) : ["center", "center"]),
			{
	...
	(Zn.util = Jn),
		...
		(Qn.extend = function (t) {
			...
			return (
				(((e.prototype = Object.create(this.prototype)).constructor = e).options = In(this.options, t)), (e.super = this), (e.extend = this.extend), e
			);
		}),
		...
		(function (i) {
			...
			(i.prototype.$create = function (t, e, n) {
				...
				(i.prototype.$mount = function (t) {
					...
					t[r] || (t[r] = {}),
						t[r][e] || (((t[r][e] = this).$el = this.$options.el = this.$options.el || t), Nt(t, document) && this._callConnected());
				}),
			...
			methods: {
													...
													: ((o = u),
													  function (t, e) {
															...
															return e
																...
																: en.out(t, n[1] || n[0], i, o.origin).then(function () {
																		return r(t, !1);
																  });
													  })
												: u._toggle
				...
				isToggled: function (t) {
					return (
						...
						(!Pe(t, this.clsLeave) && (this.cls ? Pe(t, this.cls.split(" ")[0]) : !st(t, "hidden")))
					);
				},
				_toggle: function (t, e) {
					...
					t &&
						((e = Boolean(e)),
						this.cls
							? (n = w(this.cls, " ") || e !== Pe(t, this.cls)) && He(t, this.cls, w(this.cls, " ") ? void 0 : e)
		...
		methods: {
			toggle: function (t, r) {
				...
				this.multiple || w(t, e[0]) || (e = e.concat(t)),
					(!this.collapsible && t.length < 2 && !Tt(e, ":not(." + this.clsOpen + ")").length) ||
			...
			update: {
				read: function () {
					var t = this.$el,
						e =
							(function (t) {
								for (; (t = Et(t)); ) if ("static" !== Ve(t, "position")) return t;
							})(t) || Et(t),
						n = e.offsetHeight,
						e = e.offsetWidth,
						n = nt.cover(
		...
		$i = {
				...
				},
				{
					...
					handler: function (t) {
						...
						this.$el === t
							...
							: (yi = null === yi && Nt(t, this.$el) && this.isToggled() ? this : yi);
					},
				},
			],
			update: {
			...
			methods: {
				...
				position: function () {
					...
					"justify" === this.align
						? ((t = "y" === this.getAxis() ? "width" : "height"), Ve(this.$el, t, n[t]))
						: this.boundary && this.$el.offsetWidth > Math.max(e.right - n.left, n.right - e.left) && Ne(this.$el, this.clsDrop + "-stack"),
	...
	function Bi(t) {
		...
		return (
			e && r && (Ve(t, "minHeight", ""), (n = t.map(Di)), (i = Math.max.apply(Math, n))),
			{
	...
	var Oi = {
			...
			update: {
				read: function (t) {
					...
					return (
						this.expand
							? (n = un(window) - (rn(document.documentElement).height - rn(this.$el).height) - i || "")
							: ((n = "calc(100vh"),
							  ...
							  !0 === this.offsetBottom
									...
									: z(this.offsetBottom) && (n += " - " + rn(Pt(this.offsetBottom, this.$el)).height + "px"),
							  (n += (i ? " - " + i + "px" : "") + ")")),
						{
							minHeight: n,
							prev: e,
		...
		update: {
			...
			write: function (t) {
				...
				this.dataSrcset &&
					...
					((!(n = Ve(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && L(n) !== t.bgSize) ||
						((t.bgSize =
							((e = this.dataSrcset),
							(n = this.sizes),
							(i = fn(nr(n))),
		...
		methods: {
			load: function (t) {
				...
				t.some(function (t) {
					...
					((this._data.image = me(this.dataSrc, this.dataSrcset, this.sizes).then(
						function (t) {
	...
	function tr(t, e, n, i) {
		sr(t)
			...
			: e && !w(t.style.backgroundImage, e) && (Ve(t, "backgroundImage", "url(" + Gt(e) + ")"), Qt(t, te("load", !1)));
	}
				...
				},
				{
					...
					handler: function (t, e) {
						var n = e.$el,
							e = e.dir;
						Pe(n, this.clsDrop) &&
							("slide" === this.dropbarMode && Ne(this.dropbar, "uk-navbar-dropbar-slide"),
		...
		br = {
			...
			events: [
				...
				},
				{
					...
					self: !0,
					handler: function () {
						"reveal" !== this.mode || Pe(Et(this.panel), this.clsMode) || ($e(this.panel, "<div>"), Ne(Et(this.panel), this.clsMode)),
		...
		Ct = {
			...
			computed: {
				...
				isActive: {
					...
					set: function (t) {
						t && !this.isActive
							? (Oe(this.selTarget, this.clsInactive, this.clsActive), Qt(this.$el, "active"))
							: t || Pe(this.selTarget, this.clsInactive) || (Oe(this.selTarget, this.clsActive, this.clsInactive), Qt(this.$el, "inactive"));
					},
				},
			},
			connected: function () {
			...
			update: [
				{
					read: function (t, e) {
						...
						e = kr("bottom", this);
						return (
							(this.top = Math.max(L(kr("top", this)), this.topOffset) - this.offset),
					...
					write: function (t, e) {
						...
						(t.lastScroll = c) < 0 ||
							...
							(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - c) <= 30 && Math.abs(u - c) <= 10) ||
								(this.inactive ||
								c < this.top ||
								(this.showOnUp && (c <= this.top || ("down" === s && r) || ("up" === s && !this.isFixed && c <= this.bottomOffset)))
									? this.isFixed
										? ((this.isFixed = !1),
										  this.animation && c > this.topOffset
												...
												: this.hide())
										: en.inProgress(this.$el) && c < e && (en.cancel(this.$el), this.hide())
									: this.isFixed
									? this.update()
									: this.animation
									? (en.cancel(this.$el), this.show(), en.in(this.$el, this.animation).catch(Q))
									: this.show()));
					},
					events: ["resize", "scroll"],
				},
				...
				},
				{
					...
					handler: function (t) {
						...
						(zt(t.target, 'a[href="#"], a[href=""]') ||
							((e = zt(t.target, "a[href]")) && (!Er(this.target, this.cls) || (e.hash && At(this.target, e.hash))))) &&
							t.preventDefault(),
							this.toggle();
					},
				},
				...
				events: [
					{
						...
						handler: function (t) {
							var e;
							!this.draggable ||
								(!se(t) && !(e = t.target).children.length && e.childNodes.length) ||
								zt(t.target, St) ||
								0 < t.button ||
								this.length < 2 ||
								this.start(t);
					...
					move: function (t) {
						...
						if (!(0 == n || this.prevPos === this.pos || (!this.dragging && Math.abs(n) < this.threshold))) {
							...
							[this.index, this.prevIndex]
								...
								n && ((this.prevIndex = r), (this.index = s), h || Qt(c, "beforeitemhide", [this]), Qt(t, "beforeitemshow", [this])),
								(this._transitioner = this._translate(Math.abs(this.percent), c, !h && t)),
								n && (h || Qt(c, "itemhide", [this]), Qt(t, "itemshow", [this]));
						}
					},
					end: function () {
						var t;
							...
							r &&
								...
								"image" === e || r.match(/\.(avif|jpe?g|a?png|gif|svg|webp)($|\?)/i)
									...
									: (s = r.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/)) &&
									  pe("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(r), {
											responseType: "json",
											withCredentials: !1,
									  }).then(
											function (t) {
	...
	var Kr = [
		...
		pr = {
			...
			computed: {
				...
				covers: function (t, e) {
					return (
						(i = (n = e).style.backgroundSize), (e = "cover" === Ve(Ve(n, "backgroundSize", ""), "backgroundSize")), (n.style.backgroundSize = i), e
					);
					var n, i;
				},
			},
				...
				read: function (t) {
					...
					this.matchMedia &&
						(t.image ||
							!this.covers ||
							!this.bgProps.length ||
							((e = Ve(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) &&
								(((n = new Image()).src = e),
								...
								return (
									s < u + i &&
										(w(t, (n = !r.center && n > r.maxIndex ? r.maxIndex : n)) ||
											((e = r.slides[n + 1]),
											r.center && e && i < a - rn(e).width / 2 ? (a -= i) : ((a = o), t.push(n), (s = u + o + (r.center ? i / 2 : 0))))),
									(u += i),
									t
								);
							}, []))
		...
		events: {
			beforeitemshow: function (t) {
				...
				var e = Math.abs(
					this.index -
						this.prevIndex +
						((0 < this.dir && this.index < this.prevIndex) || (this.dir < 0 && this.index > this.prevIndex) ? (this.maxIndex + 1) * this.dir : 0)
				);
				...
				move: function (t) {
					...
					Jt(document, gt, this.move),
						...
						this.drag &&
							...
							this === t
								? this.origin.index !== Ot(this.placeholder) && Qt(this.$el, "moved", [this, this.placeholder])
								: (Qt(t.$el, "added", [t, this.placeholder]), Qt(this.$el, "removed", [this, this.placeholder])),
		...
		methods: {
			show: function () {
				...
				!this.isToggled(this.tooltip) &&
					this.title &&
					((this._unbind = Zt(document, "show keydown " + mt, this.hide, !1, function (t) {
						return (
							(t.type === mt && !Nt(t.target, e.$el)) ||
							("keydown" === t.type && 27 === t.keyCode) ||
							("show" === t.type && t.detail[0] !== e && t.detail[0].$name === e.$name)
						);
					})),
			...
			_show: function () {
				...
				(this.tooltip = we(
					...
					Kt(this.tooltip, "toggled", function (t, e) {
						n.updateAria(e),
							e && (n.positionAt(n.tooltip, n.$el), (n.origin = "y" === n.getAxis() ? dn(n.dir) + "-" + n.align : n.align + "-" + dn(n.dir)));
					}),
